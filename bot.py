...
# Import role utilities (no db parameter needed)
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # We don't need db here because language selection is always shown
    keyboard = [
        [InlineKeyboardButton(get_text("lang_fa", "fa"), callback_data="lang_fa")],
        [InlineKeyboardButton(get_text("lang_en", "fa"), callback_data="lang_en")],
        [InlineKeyboardButton(get_text("lang_az", "fa"), callback_data="lang_az")],
...
async def language_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        role = get_user_role(user_id)  # no db parameter
        clinic_id = get_user_clinic_id(user_id)  # no db parameter
...
async def main_menu_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    db = SessionLocal()
    try:
        lang = get_user_language(user_id)  # no db parameter
        if not lang:

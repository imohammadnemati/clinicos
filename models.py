...
class Patient(Base):
    ...
    status = Column(String(20), default='active')   # active, cold, dead, spam, customer, archived
...
class PatientAlias(Base):
    ...
    created_at = Column(DateTime, default=datetime.utcnow)
    __table_args__ = (Index('idx_platform_phone', 'platform', 'phone'),
...
# مدل‌های Content Brain (اختیاری) در صورت نیاز اضافه می‌شوند.